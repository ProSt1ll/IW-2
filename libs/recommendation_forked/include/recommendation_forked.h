#ifndef LIBS_RECOMMENDATION_FORKED_INCLUDE_FIND_WORDS_H_
#define LIBS_RECOMMENDATION_FORKED_INCLUDE_FIND_WORDS_H_
...
#endif  // LIBS_RECOMMENDATION_FORKED_INCLUDE_FIND_WORDS_H_
